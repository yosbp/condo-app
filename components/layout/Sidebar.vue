            ...
            <ul class="relative space-y-0.5 p-4 py-0 font-semibold">
              ...
              <li class="nav-item">
                <ul>
                  <!-- Units -->
                  <li class="nav-item">
                    <NuxtLink to="/units" class="group" @click="toggleMobileMenu">
                      <div class="flex items-center">
                        <svg
                          class="group-hover:!text-primary shrink-0"
                          width="20"
                  ...
                  <!-- Expenses -->
                  <li class="nav-item">
                    <NuxtLink to="/expenses" class="group" @click="toggleMobileMenu">
                      <div class="flex items-center">
                        <svg
                          class="group-hover:!text-primary shrink-0"
                          width="20"
                  ...
                  <!-- Incomes -->
                  <li class="nav-item">
                    <NuxtLink to="/incomes" class="group" @click="toggleMobileMenu">
                      <div class="flex items-center">
                        <svg
                          class="group-hover:!text-primary shrink-0"
                          width="20"
