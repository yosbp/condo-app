            ...
            <div class="h-full bg-white dark:bg-[#0e1726]">
                <div class="flex items-center justify-between px-4 py-3">
                    <NuxtLink to="/" class="main-logo flex shrink-0 items-center">
                        ...
                        <span
                            class="align-middle text-2xl font-semibold ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light lg:inline">CONDO</span>
                    </NuxtLink>
                    <a href="javascript:;"
                    ...
                    <perfect-scrollbar :options="{
                        ...
                        <ul class="relative space-y-0.5 p-4 py-0 font-semibold">
                            ...
                            <li class="nav-item">
                                <ul>
                                    <li class="nav-item">
                                        <NuxtLink to="/test2" class="group" @click="toggleMobileMenu">
                                            <div class="flex items-center">
                                                <svg class="group-hover:!text-primary shrink-0" width="20" height="20"
                                                    viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span
                                                    class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">test</span>
                                            </div>
                                        </NuxtLink>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="menu nav-item">
                                        ...
                                        <vue-collapsible :isOpen="activeDropdown === 'invoice'">
                                            <ul class="sub-menu text-gray-500">
                                                ...
                                                <li>
                                                    <NuxtLink to="/apps/invoice/add" @click="toggleMobileMenu">{{ $t('add')
                                                    }}</NuxtLink>
                                                </li>
                                                <li>
                                                    <NuxtLink to="/apps/invoice/edit" @click="toggleMobileMenu">{{
                                                        $t('edit') }}</NuxtLink>
                                                </li>
                                            </ul>
                                        </vue-collapsible>
