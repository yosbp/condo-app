      ...
      <div class="h-full bg-white dark:bg-[#0e1726]">
        <div class="flex items-center justify-between px-4 py-3">
          <NuxtLink to="/admin" class="main-logo flex shrink-0 items-center">
            <img class="ml-[5px] w-8 flex-none mr-4" src="/assets/images/logo.png" alt="" />
            <span class="align-middle text-2xl font-semibold ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light lg:inline">CONDO</span>
          </NuxtLink>
          <a
            href="javascript:;"
          ...
          >
            <ul class="relative space-y-0.5 p-4 py-0 font-semibold">
              ...
              <li class="nav-item">
                <ul>
                  <li class="nav-item">
                    <NuxtLink to="/user" class="group" @click="toggleMobileMenu">
                      <div class="flex items-center">
                        ...
                        <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Panel</span>
                      </div>
                    </NuxtLink>
                  </li>
                </ul>
              ...
              <li class="nav-item">
                <ul>
                  <!-- Reported Payments -->
                  <li class="nav-item">
                    <NuxtLink to="/user/report-payment" class="group" @click="toggleMobileMenu">
                      <div class="flex items-center">
                        <svg
                          class="group-hover:!text-primary shrink-0"
                          width="20"
                        ...
                        <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{{ $t('report-payment') }}</span>
                      </div>
                    </NuxtLink>
                  </li>
                </ul>
